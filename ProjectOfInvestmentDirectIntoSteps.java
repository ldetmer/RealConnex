...
public class ProjectOfInvestmentDirectIntoSteps {
    ...
    public void verifyProjectOfInvestmentBanker(){
        Assert.assertTrue("Searched Results are not matching", projectOfInvestmentBankerDirectIntoPage.verifyProjectOfInvestmentBanker(1));
    }

    @Then("I verify listing project of investments is displayed")
    public void verifyListingOfInvestmentBanker(){
        Assert.assertTrue("Searched Results are not matching", projectOfInvestmentBankerDirectIntoPage.verifyListingOfInvestmentBanker(1));
    }

...
I Verify that users other than "Deal Sponsor", "Developer" and "Fund Sponsor"
sub roles are not retrieved when "Developer, Deal Sponsor >> Deal Sponsor, Developer, Fund Sponsor" search is performed.

Scenario: TC 138396: Verify user other than deal sponsor,developer and fund sponsor are not displayed when search is performed
...
Then I verify user of 'Buy Land' is displayed
...
Then I verify user of 'Portfolio Acquisitions' is displayed
And I verify user of 'Operating Companies' is not displayed
And I verify user of 'Platform Builds' is not displayed

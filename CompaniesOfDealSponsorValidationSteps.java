...
public class CompaniesOfDealSponsorValidationSteps {
    ...
    @When("I clear asset option in asset type")
    public void clearProject(){
        companiesOfDealSponsorValidationPage.clearProject();
    }
    ...
    @Then("I verify deal sponsor company of '$strSideSearch' is displayed")
    ...
    @Then("I verify deal sponsor company of '$strSideSearch' is not displayed")
    public void companyNotDisplayed(@Named("strSideSearch") String strSideSearch){
        boolean status = companiesOfDealSponsorValidationPage.companyNotDisplayed(2,strSideSearch);
        Assert.assertTrue("The Searched String is found in the List", status);
    }

    @When("I check on asset")
    public void checkAsset(){
        companiesOfDealSponsorValidationPage.checkAsset();
    }

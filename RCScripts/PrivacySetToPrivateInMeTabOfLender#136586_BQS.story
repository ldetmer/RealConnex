...
Narrative:
As a user
I Verify that when "Lender" user sets privacy to "Private" in "Me >> Privacy" page, only users who have been granted permission can view Me Profile.
...
And I click on 'People' link
Then I should see 'People, Companies & Associations' as find in search option
And I verify 'Lena Taylor' lender user name is displayed in search result
When I click on 'Lena Taylor' lender user name in search result
...
And I click on 'People' link
Then I should see 'People, Companies & Associations' as find in search option
And I verify lender user whose profile is set private is not displayed
When I logout RealConnex application
And I click on Log In button in RealConnex login page

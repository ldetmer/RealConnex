...
Narrative:
As a user
I Select “Deal Sponsor” role and verify that only the user with Deal sponsor role can access “Me” profile after permission is granted.

Scenario: 143823 : Verify that only deal sponsor user cannot access me profile after permission is granted in my universe exclude
When I update TestCaseId 143823
When I update TestCaseName Select “Deal Sponsor” role and verify that only the user with Deal sponsor role can access “Me” profile after permission is granted.
...
And I verify click here link of the private user is displayed in search result
When I logout RealConnex application
And I click on Log In button in RealConnex login page

...
Narrative:
As a user
I Verify that projects of other role users except Deal Sponsors can be viewed after permission is granted.

Scenario: 136653 : Verify that project can be viewed by other role user except deal sponsor after permission is granted
When I update TestCaseId 136653
When I update TestCaseName Verify that projects of other role users except Deal Sponsors can be viewed after permission is granted.

...
Then I verify project name of 'The Asset' option is displayed
And I verify project name of 'CD' option is not displayed
...
Then I verify project name of 'Commercial' option is displayed
And I verify project name of 'Industrial' option is not displayed
...
Then I verify project name of 'Development' option is displayed
And I verify project name of 'Opportunistic' option is not displayed
...
Then I verify project name of 'Concept' option is displayed
And I verify project name of 'Under Contract' option is not displayed
...
Then I verify project name of 'Partially Rented' option is displayed
And I verify project name of 'Entitled' option is not displayed
...
Then I verify project name of 'Land Bank' option is displayed
...
Then I verify project name of 'Mezz Fund' option is displayed
And I verify project name of 'Endowment Fund' option is not displayed

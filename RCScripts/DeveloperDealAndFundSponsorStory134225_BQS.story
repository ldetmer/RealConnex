...
I Verify that "Deal Sponsor", "Developer" and "Fund Sponsor" are
retrieved when deal sponsor search is performed.

Scenario: TC 134225: Verify deal sponsor,developer and fund sponsor are displayed when search is performed
When I update TestCaseId 134225
...
And I should see 'Developer, Deal Sponsor, Fund Sponsor' as subrole in search option
...
And I click on 'Strategy' drop down field
And I select option in 'Strategy' type
Then I verify company of 'Portfolio Acquisitions' is displayed
And I verify user of 'Portfolio Acquisitions' is displayed
And I verify company of 'Operating Companies' is not displayed
And I verify user of 'Operating Companies' is not displayed
And I verify company of 'Platform Builds' is not displayed
And I verify user of 'Platform Builds' is not displayed
...
Then I verify company of 'Platform Builds' is not displayed
And I verify user of 'Platform Builds' is not displayed
And I verify company of 'Portfolio Acquisitions' is displayed
And I verify user of 'Portfolio Acquisitions' is displayed
And I verify company of 'Operating Companies' is displayed
And I verify user of 'Operating Companies' is displayed
When I click on 'Strategy' drop down field
...
And I verify fund sponsor user of all option is displayed

...
Narrative:
As a user
Select “Deal Sponsor” role and "Sub-Role" and verify that only the user with Deal sponsor role and specified Sub-role can access “Company” profile after permission is granted.

Scenario: 147635 : Verify that only deal sponsor role and developer subrole user can access company profile after permission is granted in my universe include
When I update TestCaseId 147635
When I update TestCaseName Select “Deal Sponsor” role and "Sub-Role" and verify that only the user with Deal sponsor role and specified Sub-role can access “Company” profile after permission is granted.

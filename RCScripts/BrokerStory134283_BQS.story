...
Narrative:
As a user
I verify 'Service' project of users who have selected "Broker" option
are retrieved, when "Real Estate Advisors >> Advisor" search is performed

Scenario: TC 134283: Verify service project is retrieved when Advisor search is performed
When I update TestCaseId 134283
...
Then I verify service of 'Acquisitions' is displayed
And I verify service of 'Investments' is not displayed
...
Then I verify service of 'Solar' is displayed
And I verify service of 'Broker Multi Family' is not displayed
And I verify service of 'Broker Hotel' is not displayed
When I click on 'Asset Experience'
...
Then I verify service of 'In DD' is displayed
And I verify service of 'Owned' is not displayed

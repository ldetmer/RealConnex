...
And I verify 'RL Service' of real estate advisor service name is displayed in jv partner project search
When I logout RealConnex application
And I click on Log In button in RealConnex login page
And I enter lender email id who has created the jv requirement in project
And I enter Password
And I click on login button
Then I should see 'Find Now' image
...
And I verify 'Taylor Service' of real estate advisor service name is displayed when click on matches of jv partner project search
...
And I verify 'RL Service' of real estate advisor service name is displayed in jv partner result in jv partner project search
When I click on route to partnership drop down

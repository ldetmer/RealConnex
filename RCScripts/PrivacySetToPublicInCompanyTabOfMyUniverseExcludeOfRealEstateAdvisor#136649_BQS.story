...
Narrative:
As a user
I Verify that only companies of Property Serivce Provider users excluded from My Universe are invisible when the privacy is set to "Exclude the following from my universe" in "Company >> Privacy" tab.
...
When I update TestCaseName Verify that only companies of Property Serivce Provider users excluded from My Universe are invisible when the privacy is set to "Exclude the following from my universe" in "Company >> Privacy" tab.

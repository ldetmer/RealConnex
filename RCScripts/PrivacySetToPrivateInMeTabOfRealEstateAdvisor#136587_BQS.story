...
Narrative:
As a user
I Verify that when "Property Service Provider" user sets privacy to "Private" in "Me >> Privacy" page, only users who have been granted permission can view Me Profile.

Scenario: 136587 : Verify that property service provider user privacy is set to "Private" in "Me" page can be viewed to user who have permission
When I update TestCaseId 136587
When I update TestCaseName Privacy Set To Private In Me Tab Of Real Estate Advisor
...
And I click on 'People' link
Then I should see 'People, Companies & Associations' as find in search option
And I verify 'Elizabeth Lee' real estate advisor,broker user name is displayed in search result
When I click on 'Elizabeth Lee' real estate advisor,broker user name in search result
...
And I click on 'People' link
Then I should see 'People, Companies & Associations' as find in search option
And I verify real estate advisor,broker user whose profile is set private is not displayed
When I click on 'Find Now' button
And I logout RealConnex application

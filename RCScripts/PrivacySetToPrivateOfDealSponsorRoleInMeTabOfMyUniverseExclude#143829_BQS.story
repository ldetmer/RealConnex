...
Narrative:
As a user
I Select “Deal Sponsor” role and verify that only the user with Deal sponsor role cannot access “Me” profile after permission is granted.

Scenario: 143829 : Verify that only deal sponsor user cannot access me profile after permission is granted in my universe exclude
When I update TestCaseId 143829
When I update TestCaseName Select “Deal Sponsor” role and verify that only the user with Deal sponsor role cannot access “Me” profile after permission is granted.

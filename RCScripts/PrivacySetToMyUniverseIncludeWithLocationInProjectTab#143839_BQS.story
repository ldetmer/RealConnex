...
Narrative:
As a user
I Set location as privacy>>include and verify that only the users with matching location can access “Project” profile.

Scenario: 143839 : Verify that only deal sponsor user can access project when deal sponsor user is included in my universe
When I update TestCaseId 143839
When I update TestCaseName Set location as privacy>>include and verify that only the users with matching location can access “Project” profile.

...
public class CompaniesOfDealSponsorPage extends FluentWebDriverPage{
    ...
    public void verifyDealCompanyName(int RowIndex){
        try{
            String strCompanyName = ReadData.readDataExcel("CompaniesOfDealDeveloperFund", RowIndex, "VerifyDealCompanyName");
            String strName = findElement(By.xpath("//tbody[@id='searchResults']/tr/td/a/strong[contains(text(),'"+strCompanyName+"')]")).getText();
            Assert.assertTrue(strCompanyName,strName.contains(strCompanyName));
        } catch (Exception e) {
    ...
    public void verifyCompanyName(int RowIndex){
        try{
            String strCompanyName = ReadData.readDataExcel("CompaniesOfDealDeveloperFund", RowIndex, "VerifyDealCompanyName");
            String strName = findElement(By.xpath("//tbody[@id='searchResults']/tr/td/a/strong/span[contains(text(),'"+strCompanyName+"')]")).getText();
            Assert.assertTrue(strCompanyName,strName.contains(strCompanyName));
        } catch (Exception e) {
            System.out.println(e);
        }

...
public class FundSponsorPage extends FluentWebDriverPage {
    ...
    public boolean companyNameOfAllSearchOption(int RowIndex){
        ...
        try{
            ...
            for(int i=1;i<=linksCount;i++){
                String strDSLocation = ReadData.readDataExcel("DealSponsorDeveloperFund", RowIndex, "CompanyOfFundSponsorAllSearchOption");
    ...
    public boolean userOfAllSearchOption(int RowIndex){
        ...
        try{
            ...
            linksCount = linksCount/2;
            for(int i=1;i<=linksCount;i++){
                String strDSLocation = ReadData.readDataExcel("DealSponsorDeveloperFund", RowIndex, "FundSponsorOfAllSearchOption");

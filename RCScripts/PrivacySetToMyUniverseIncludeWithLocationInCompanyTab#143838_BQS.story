...
Narrative:
As a user
I Set location as privacy>>include and verify that only the users with matching location can access “Company” profile.

Scenario: 143838 : Verify that only user with matching location can access company profile in my universe exclude
When I update TestCaseId 143838
When I update TestCaseName Set location as privacy>>include and verify that only the users with matching location can access “Company” profile.

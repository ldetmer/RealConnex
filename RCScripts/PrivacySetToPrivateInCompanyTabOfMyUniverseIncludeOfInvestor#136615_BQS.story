...
And I select advisor option in We are a field
...
Then I should see 'People, Companies & Associations' as find in search option
When I enter deal sponsor company name who has set the profile to private in include of my universe
Then I verify 'SRoss Company' company name who has set privacy include in my universe is displayed
When I click 'SRoss Company' company name who has set privacy include in my universe

...
Narrative:
As a user
I Set location as privacy>>include and verify that only the users with matching location can access “Me” profile.

Scenario: 143837 : Verify that only user with matching location can access me profile in my universe exclude
When I update TestCaseId 143837
When I update TestCaseName Set location as privacy>>include and verify that only the users with matching location can access “Me” profile.

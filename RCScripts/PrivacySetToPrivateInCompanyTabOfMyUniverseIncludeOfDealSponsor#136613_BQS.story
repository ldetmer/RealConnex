...
Narrative:
As a user
I Verify that only Deal Sponsor user can view Company Profile after permission is granted when Deal Sponsor user is included in My Universe.

Scenario: 136613 : Verify that deal sponsor user can view company profile after permission is granted when deal sponsor user is included in my universe
...
And I select developer option in We are a field

...
Then I verify company of fund sponsor selected 'Direct Only' is not displayed
When I click on 'Route to Sponsor' drop down field
...
Then I verify company of fund sponsor selected 'Hotel' is not displayed
When I click on asset type field of deal sponsor search
...
Then I verify company of fund sponsor selected 'Core Plus' is not displayed
When I click on 'RiskProfile' drop down field
...
Then I verify company of fund sponsor selected 'Lease-Up' is not displayed
When I click on 'Asset Strategy' drop down field

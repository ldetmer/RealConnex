...
Narrative:
As a user
I verify companies of the users who have selected "Advisor" option
are retrieved, when "Real Estate Advisors >> Advisor" search is performed

Scenario: TC 135562: Verify companies of advisor is retrieved when Advisor search is performed
When I update TestCaseId 135562
...
Then I verify company of 'Appraisals' is displayed
And I verify company of 'Owner' is not displayed
...
Then I verify company of 'Appraisals' is displayed
And I verify service of 'Appraisals' is displayed
And I verify company of 'Owner' is not displayed
...
Then I verify company of 'Advisor Office' is displayed
And I verify company of 'Advisor Multi Family' is not displayed
And I verify company of 'Advisor Hotel' is not displayed
When I click on 'Asset Experience'
And I select two options in asset drop down
Then I verify company of 'Advisor Office' is displayed
And I verify service of 'Advisor Office' is displayed
And I verify company of 'Advisor Multi Family' is not displayed
...
Then I verify advisor company name of all search option is displayed
And I verify advisor service name of all search option is displayed
When I click on 'Asset Experience'
...
Then I verify company of 'Owned' is displayed
And I verify service of 'Owned' is displayed
And I verify company of 'Concept' is not displayed
And I verify service of 'Concept' is not displayed
And I verify company of 'Permitted' is not displayed

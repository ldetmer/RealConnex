...
Narrative:
As a user
I verify that projects with type "Project" and "Listing" with the risk profile options
are retrieved in "Investment >> Direct Into Project" search

Scenario: TC 134362: Verify service project is retrieved when Advisor search is performed
When I update TestCaseId 134362
...
And I verify project of the investment banker
...
When I enter location of investment banker
And I click on the location drop down to select location
Then I verify project of the investment banker
When I clear location field
...
And I click on Syndicate Type check box
Then I verify project of the investment banker
When I un check Syndicate Type check box

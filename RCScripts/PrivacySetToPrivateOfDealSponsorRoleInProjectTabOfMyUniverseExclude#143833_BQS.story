...
Narrative:
As a user
I Select “Deal Sponsor” role and verify that only the user with Deal sponsor role cannot access “Project” profile after permission is granted

Scenario: 143833 : Verify that project can be viewed by other role user except deal sponsor after permission is granted
When I update TestCaseId 143833
When I update TestCaseName Select “Deal Sponsor” role and verify that only the user with Deal sponsor role cannot access “Project” profile after permission is granted

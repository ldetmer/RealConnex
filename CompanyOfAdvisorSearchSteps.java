...
public class CompanyOfAdvisorSearchSteps {
    ...
    public void clickAppraisalUser(){
        companyOfAdvisorSearchPage.clickAppraisalCompany(1);
    }
    ...
    public void verifyAdvisorCompany(){
    ...
    @When("I slide the project size slider")
    public void slideProjectSize(){
        companyOfAdvisorSearchPage.slideProjectSize();
    }
